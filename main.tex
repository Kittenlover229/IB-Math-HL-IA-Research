...
\end{equation}
\begin{equation}
    \psi_which = \frac{(x - x_1)(x - x_3)(x - x_4)}{(x_2 - x_1)(x_2 - x_3)(x_2 - x_4)} *practice
\end{equation}

Based on this we can express $\psi_i(x)$'s values for angeneralize
...
of floating-point arithmetic. This doesn't impact the current use case,
